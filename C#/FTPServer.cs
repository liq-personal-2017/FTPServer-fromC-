...
namespace ftptest
{
    ...
    public class FTPServer
    {
        ...
        private long GetFileSize(string strFileName)
        {
            ...
            SendCommand("SIZE " + System.IO.Path.GetFileName(strFileName));
            long lSize = 0;
            if (iReplyCode == 213)
            {
        ...
        public void Get(string strFileNameMask, string strFolder)
        {
            ...
            {
                string strFile1 = strFile.Trim('\r');
        ...
        public void Get(string strRemoteFileName, string strFolder, string strLocalFileName)
        {
            ...
            {
                Stream st = File.Create(strOutputPath);
                st.Close();
            }
        ...
        public void Put(string strFileName)
        {
            ...
            Socket socketData = CreateDataSocket();
            SendCommand("STOR " + System.IO.Path.GetFileName(strFileName));
            if (!(iReplyCode == 125 || iReplyCode == 150))
            {
                throw new IOException(strReply.Substring(4));
            }
            System.IO.FileStream input = new
            System.IO.FileStream(strFileName, FileMode.Open);
            int iBytes = 0;
